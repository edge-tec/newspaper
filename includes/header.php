...
$todayBn = $bnDays[date('l')] . ', ' . en2bn(date('j')) . ' ' . $bnMonths[date('F')] . ' ' . en2bn(date('Y'));
?>
<!DOCTYPE html>
<html lang="bn">
<head>
    ...
    <!-- Fonts (Added Noto Sans Bengali for better readability) -->
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Noto+Serif+Bengali:wght@500;700&family=Playfair+Display:wght@700;800&display=swap" rel="stylesheet">
    <!-- Bootstrap -->
...
<div class="bg-dark text-white-50 py-1 d-none d-md-block" style="font-size:13px;">
    <div class="container d-flex justify-content-between">
        <span><i class="bi bi-calendar3 me-1"></i> <?php echo $todayBn; ?></span>
        <div>
            <?php if (isLoggedIn()): ?>
                <?php if (isReporter()): ?>
                    <a href="<?php echo SITE_URL; ?>/reporter/index.php" class="text-white-50 text-decoration-none me-3"><i class="bi bi-speedometer2 me-1"></i>আমার ড্যাশবোর্ড</a>
                <?php else: ?>
                    <a href="<?php echo SITE_URL; ?>/admin/index.php" class="text-white-50 text-decoration-none me-3"><i class="bi bi-gear me-1"></i>অ্যাডমিন</a>
                <?php endif; ?>
                <a href="<?php echo SITE_URL; ?>/admin/logout.php" class="text-white-50 text-decoration-none">লগআউট</a>
            <?php else: ?>
                <a href="<?php echo SITE_URL; ?>/admin/login.php" class="text-white-50 text-decoration-none me-3"><i class="bi bi-box-arrow-in-right me-1"></i>লগইন</a>
                <a href="<?php echo SITE_URL; ?>/register.php" class="text-white-50 text-decoration-none"><i class="bi bi-person-plus me-1"></i>রেজিস্ট্রেশন</a>
            <?php endif; ?>
        </div>
    </div>
</div>
...
<header class="sticky-top bg-white border-bottom shadow-sm">
    ...
    <div class="border-top">
        <div class="container">
            <nav class="nav d-flex flex-wrap justify-content-center text-uppercase fw-semibold" style="font-size:14px;">
                <a class="p-2 px-3 link-secondary text-decoration-none" href="<?php echo SITE_URL; ?>">হোম</a>
...
<div class="bg-danger text-white py-2">
    <div class="container d-flex align-items-center">
        <span class="fw-bold me-3 text-uppercase flex-shrink-0" style="font-size:14px; letter-spacing:1px;">ব্রেকিং নিউজ</span>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header border-0 pb-0">
        <h5 class="modal-title fw-bold">খবর খুঁজুন</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        <form action="<?php echo SITE_URL; ?>/search.php" method="GET">
            <div class="input-group input-group-lg">
                <input type="text" name="q" class="form-control" placeholder="খবর খুঁজুন..." required>
